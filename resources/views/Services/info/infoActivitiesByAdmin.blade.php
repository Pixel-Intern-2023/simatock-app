...
@section('content')
    <h2 class="text-center text-xl dark:text-gray-300">Aktifitas admin <span class="text-primary">{{ $admin->name }}</span></h2>
                            ...
                            <div class="relative me-5 md:me-0 md:ms-10">
                                <div class="card p-5">
                                    ...
                                    <p class="mb-4 text-gray-500 dark:text-gray-400">
                                        {{ $item->product->products_name . ' ' . $item->amount_out . ' ' . optional($item->product->unit)->unit ?? 'Unit tidak tersedia' }} dikeluarkan
